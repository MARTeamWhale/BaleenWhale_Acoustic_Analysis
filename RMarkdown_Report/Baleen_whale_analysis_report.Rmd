...
annotations <- read_csv(paste0(r"(R:\Science\CetaceanOPPNoise\CetaceanOPPNoise_5\BaleenWhale_AcousticAnalysis\Deployments\)",params$deployment,r"(\Results\)", params$deployment,"_DPA_MB_Annotations_FINAL.csv", sep=""))
...
for (i in rownames(TableFileLFDCS2)) {
